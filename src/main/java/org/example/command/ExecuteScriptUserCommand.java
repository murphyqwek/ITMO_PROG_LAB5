...
public class ExecuteScriptUserCommand extends UserCommand {
     ...
     */
    public ExecuteScriptUserCommand(CollectionManager collectionManager, FileManager fileManager, IOManager ioManager) {
    ...
    public void execute(ArrayList<String> args) throws CommandArgumentExcetpion {
        ...
        ScriptManager scriptManager = new ScriptManager(args.get(0), collectionManager, fileManager);

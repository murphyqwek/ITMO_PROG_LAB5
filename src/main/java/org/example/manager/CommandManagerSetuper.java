...
public class CommandManagerSetuper {
     ...
     */
    public static void SetupCommandManager(IOManager ioManager, CollectionManager collectionManager, CommandManager commandManager, FileManager fileManager) {
        ...
        commandManager.addCommand(new SaveUserCommand(collectionManager, fileManager, ioManager));
        commandManager.addCommand(new ExecuteScriptUserCommand(collectionManager, fileManager, ioManager));
    }
}
